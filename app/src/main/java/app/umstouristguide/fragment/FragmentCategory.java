package app.umstouristguide.fragment;
...
import app.umstouristguide.ActivityMain;
import app.umstouristguide.ActivityPlaceDetail;
import app.umstouristguide.R;
import app.umstouristguide.adapter.AdapterPlaceGrid;
import app.umstouristguide.connection.RestAdapter;
import app.umstouristguide.connection.callbacks.CallbackListPlace;
import app.umstouristguide.data.AppConfig;
import app.umstouristguide.data.Constant;
import app.umstouristguide.data.DatabaseHandler;
import app.umstouristguide.data.SharedPref;
import app.umstouristguide.data.ThisApplication;
import app.umstouristguide.model.Place;

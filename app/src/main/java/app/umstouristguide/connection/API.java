package app.umstouristguide.connection;

import app.umstouristguide.connection.callbacks.CallbackDevice;
import app.umstouristguide.connection.callbacks.CallbackListNewsInfo;
import app.umstouristguide.connection.callbacks.CallbackListPlace;
import app.umstouristguide.connection.callbacks.CallbackPlaceDetails;
import app.umstouristguide.model.DeviceInfo;
